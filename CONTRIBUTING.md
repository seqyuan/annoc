...
Contributions are made to this repo via [Issues](https://github.com/seqyuan/annocluster/issues) and [Pull Requests (PRs)](https://github.com/seqyuan/annocluster/pulls). 
...
### Issues
[Issues](https://github.com/seqyuan/annocluster/issues) should be used to report problems with the application or any of its dependencies, request a new feature, 
...
### Pull Requests
[PRs](https://github.com/seqyuan/annocluster/pulls) are always welcome and can be a quick way to get your fix or improvement merged. In general, PRs should:
...
- [Fork](https://github.com/seqyuan/annocluster/fork) the repository to your own Github account
